...
namespace FR_project.Controllers
{
    public class HomeController : Controller
    {
        ...
        public HomeController(IProductService productService, IClientService clientService, IEntrepriseService entrepriseService, ICommandeService commandeService, IWebHostEnvironment webHostEnvironment)
        {
